...
def generate_launch_description():
    ...
    lidar_ip_arg = DeclareLaunchArgument(
        ...
        description='IP address of the SICK TIM571 LiDAR'
    )
    web_ui_arg = DeclareLaunchArgument(
        'web_ui', default_value='true',
        description='Launch rosbridge + web UI (true/false)'
    )
    ...
    web_ui = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory('web_interface'),
